...
public static class PartCatalog
{
    ...
    public static readonly IReadOnlyList<PartInfo> All = new PartInfo[]
    {
        ...
        new("PickPlaceArm", "Pick & Place Gantry", "ACTUATORS",
            ...
            () => new PickPlaceArm()),
        new("ArticulatedArm", "Articulated Arm", "ACTUATORS",
            "Waist, shoulder and elbow, commanded as angles. The tool moves in arcs, some places cannot be reached at all, and near full stretch a degree of elbow is worth nothing.",
            () => new ArticulatedArm()),
        ...
        new("Remover", "Box Remover", "PROCESS",
            ...
            () => new Remover()),
        new("PalletStation", "Pallet Station", "PROCESS",
            "A pallet and the pattern that fills it. Publishes where the next carton goes, counts layers, interlocks every other one, and refuses once it is full.",
            () => new PalletStation()),
